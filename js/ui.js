const UI = (() => {
  ...
  function _validateForm() {
    ...
    if (
      ...
      _showFieldError("kohNeurons", "Введіть ціле число від 2 до 20");
      valid = false;
    }
    ...
    if (
      ...
      _showFieldError(
        "learningRateKohonen",
        "Коефіцієнт має бути від 0.01 до 1.0",
      );
      valid = false;
    }
    ...
    if (
      ...
      _showFieldError("maxEpochs", "Кількість епох має бути від 1 до 500");
      valid = false;
    }
